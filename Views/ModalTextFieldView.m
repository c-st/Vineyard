...
@synthesize delegate, textField, saveButton;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
		...
		// text field
		self.textField = [[UITextField alloc] initWithFrame:CGRectMake(80, 70, self.frame.size.width - 90, 20)];
		...
		SSLineView *line2 = [[SSLineView alloc] initWithFrame:CGRectMake(20, 100, self.frame.size.width - 30, 2)];
		[line2 setLineColor:[[UIColor lightGrayColor] colorWithAlphaComponent:0.8]];
